...
export class AppComponent implements Person {
  firstName: "string";
  lastName: "string";
  ...
  constructor(private serviceTitle: TitleServiceService,private http:Http){
   this.testServiceTitle= this.serviceTitle.title;
  ...
  changeKeyword(evt :KeyboardEvent) {
     this.keyword1 = (evt.target as HTMLInputElement).value;  
  }
  ...
  searchKeyword(tKeyword) {
    this.keyword = tKeyword.value + "hi!";
  }
  data : any;
  // data = [    
  //   {
